...
namespace DecoratorPatternTest
{
    public class BeverageTest
    {
        ...
        {
            var espresso = (Beverage) new Espresso();
        ...
        {
            var espresso = (Beverage) new MilkDecorator(new Espresso());
        ...
        {
            var espresso = (Beverage) new MochaDecorator(new Espresso());
        ...
        {
            var espresso = (Beverage) new MilkDecorator(new MochaDecorator(new Espresso()));
